...
const S1 = `{"__ref__":"`, S2 = `1g3fotqpvbaf3f770m6q700`, S3 = `","__updated__":16811521621`, S4 = `,"classId":"433329107982770176","`, S5 = `","typeId":"24","lowerValue":"1","upperValue":`, S6 = `pps06cp4ade800`, S7 = `"},"id":"4333291`, S8 = `baf3f770m6q700`, S9 = `Metamodel:`, S10 = `"}],"__id__":`, S11 = `"__type__"`, S12 = `,"identifier`, S13 = `,"acl":`, S14 = `d":"4333291`, S15 = `"name":"`, S16 = `"},"class"`, S17 = `,"_isSelected":`, S18 = `,"owningPackage`, json548081 = `{${S11}:${S1}${S9}13"},"packagedElement":[{${S15}listItem",${S11}:${S1}${S9}12"},"ownedAttribute":[{${S11}:${S1}${S9}21"}${S12}Property":[{${S11}:${S1}${S9}23"}${S13}[${S1}1g3fq4b29${S6}57${S10}"${S2}m2"${S12}I${S14}09840846848","propertyI${S14}10650347520"${S12}":{${S11}:${S1}${S9}22"}${S12}Property":[${S1}${S2}m2"}]${S13}[${S1}1g3fq3r59${S6}1t${S10}"${S2}92","type":"primary"${S4}class":${S1}${S2}6i${S7}09840846848${S3}50},"property":${S1}1g3fotqqf${S8}50${S7}13280176128${S3}58}]${S13}[${S1}1g3fq3ug9${S6}7p${S10}"1g3fotqqf${S8}50","upperValue":1,"lowerValue":"1",${S15}id","typeId":"26","autoGenerate":true${S4}type":${S1}${S9}26${S16}:${S1}${S2}6i${S7}10650347520${S3}52},{${S11}:${S1}${S9}21"}${S13}[${S1}1g3fq428p${S6}11${S10}"1g3fpcu8f${S8}7l",${S15}testName${S5}1${S4}type":${S1}${S9}24${S16}:${S1}${S2}6i${S7}10662930432${S3}53},{${S11}:${S1}${S9}21"}${S13}[${S1}1g3fq43j9${S6}4h${S10}"1g3fpi71f${S8}0e",${S15}testLink${S5}1${S4}type":${S1}${S9}24${S16}:${S1}${S2}6i${S7}10679707648${S3}53},{${S11}:${S1}${S9}21"}${S13}[${S1}1g3fq451p${S6}3e${S10}"1g3fpl4pv${S8}53",${S15}listNum${S5}1${S4}type":${S1}${S9}24${S16}:${S1}${S2}6i${S7}10700679168${S3}53}]${S12}":[${S1}${S2}92"}]${S13}[${S1}1g3fq3o69${S6}3d${S10}"${S2}6i","x":80,"y":80,"width":350,"height":300,"expanded":true${S17}0,"pX":80.03076171875,"pY":80.09051513671875${S18}I${S14}07353624576"${S18}":${S1}1g3foq3rf${S8}80${S7}07982770176${S3}46}],"authServerPackageApprovalList":[${S1}1g3frsfov${S8}3m"}]${S13}[${S1}1g3fq3gpp${S6}36${S10}"1g3foq3rf${S8}80","version":"1.0.0"${S17}1,${S15}adbeDash","i${S14}07353624576${S3}63,"packageCache":${S1}1g3fq4efp${S6}0m"},"lastModified":"1681150512030"}`;

const adbeDash = globalThis["adbeDash"] = Metamodel.resurrect(json548081);
